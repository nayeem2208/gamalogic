...
export default function IntegrationPage() {
  ...
  const features = [
    ...
    {
      title: "Pabbly",
      description: "Connect Gamalogic with more than 2,000+ apps.",
      link: "https://www.pabbly.com/connect/integrations/gamalogic/",
      image: "/pabbly_logo.png",
    },
  ];
    ...
    <div className="px-4 sm:px-6 lg:px-20 py-8 text-center sm:text-start">
      ...
      <div className="mt-14 subHeading">
        <h3 className="text-xl sm:text-2xl font-bold">
          Integrate with Our Features
        </h3>
        <p className="my-6 text-sm sm:text-base text-gray-600">
          Explore and integrate with our wide range of features to enhance your
          experience.
        </p>
