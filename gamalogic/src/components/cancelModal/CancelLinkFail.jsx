...
function CancelEmailFail({ onOkay }) {
  const handleOkay = () => {
    ...
    <div className="fixed inset-0 lg:left-[22vw] 2xl:left-[17vw] top-[-20px] z-50 flex items-center justify-center">
      <div role="alert" aria-labelledby="alert-title" aria-describedby="alert-description" className="mx-auto max-w-lg rounded-lg border border-stone bg-slate-200 p-4 shadow-xl sm:p-6 lg:p-8">
        <div className="flex items-center gap-4">
          ...
          <p id="alert-title" className="font-medium sm:text-lg text-red-500">Email Sending Error</p>
        </div>
        <p id="alert-description" className="mt-4 text-gray-700">
          There was an error sending the subscription cancellation email.
        </p>
...
export default CancelEmailFail;
