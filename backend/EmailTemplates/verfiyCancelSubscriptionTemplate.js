...
const verifyCancelSubscriptionTemplate = (name, token, link) => {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>We have received a request to cancel your subscription.</p>
                <p>To proceed with the cancellation, please use the following link to confirm your request:</p>
                <div class="verify">
                    <a href="${urls.frontendUrl}/api/ConfirmSubscriptionCancellation?email=${token}"><button
                            class="verifyButton">Confirm</button></a>
                    <p>Or</p>
                    <p>
                        <a href="${urls.frontendUrl}/api/ConfirmSubscriptionCancellation?email=${token}">${link}</a>
                    </p>
                </div>
                <p>This link is valid for the next 10 minutes. If you did not request this action, please ignore this email, and your subscription will remain active.</p>
                <br>
                <p>Best regards,<br>
                    Team Gamalogic</p>
            </div>
...
export default verifyCancelSubscriptionTemplate